                                    ...
                                    <FormControl>
                                        ...
                                        >
                                            ...
                                            <Card className="px-10 py-4 flex hover:shadow-md hover:shadow-slate-200">
                                                <FormItem className='flex gap-x-5'>
                                                    <FormControl>
                                                        <RadioGroupItem disabled={!gstInvoice?.gstin || !billingAddress?.address_line_1} value="Sole Proprietor" className='mt-3 disabled:bg-slate-300' />
                                                    </FormControl>
                                                    <FormLabel className="font-normal cursor-pointer">
                                            ...
                                            <Card className="px-10 py-4 flex hover:shadow-md hover:shadow-slate-200">
                                                <FormItem className='flex gap-x-5'>
                                                    <FormControl>
                                                        <RadioGroupItem disabled={!gstInvoice?.gstin || !billingAddress?.address_line_1} value="Company" className='mt-3 disabled:bg-slate-300' />
                                                    </FormControl>
                                                    <FormLabel className="font-normal cursor-pointer">
